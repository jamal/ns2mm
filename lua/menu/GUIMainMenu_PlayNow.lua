    ...
    local tabs = 
        {
            ...
            { label = "MATCHMAKING", func = function(self) self.scriptHandle:SetPlayContentInvisible("play_content") self.scriptHandle.matchmakingWindow:SetIsVisible(true) end },
